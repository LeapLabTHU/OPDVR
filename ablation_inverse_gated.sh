...
export CORRECTNESS_GATED_MODE=${CORRECTNESS_GATED_MODE:-inverse}
...
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-opdvr_inverse_gated_${LOG_PROB_TOP_K}_${ACTOR_MODEL_PATH##*/}_$(date +%Y%m%d_%H%M%S)}
